...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkAgentEngineHermesHint: 'WeSight 内置托管的 Hermes Agent runtime，适合通过图形化对话使用 Hermes 的本地 agent 能力。',
    ...
    coworkAgentEngineCodex: 'Codex',
    coworkAgentEngineCodexHint: '读取本机 Codex CLI 与 Codex 配置，适合通过 OpenAI Codex 执行本地任务。',
    ...
    coworkAgentConfigSourceHint: '选择任务启动时 Claude Code 与 Codex 使用哪套模型配置。',
    coworkAgentConfigSourceWesightModel: '跟随 WeSight 模型设置',
    coworkAgentConfigSourceWesightModelHint: '使用“设置 > 模型”中的当前模型，启动任务前自动写入对应 CLI 配置。',
    ...
    coworkHermesInstallHint: 'Hermes Agent 运行时由 WeSight 托管。切换到该引擎或启动任务时会自动拉起网关。',
    coworkHermesInstalling: '正在启动 Hermes Agent...',
    ...
    coworkHermesNotInstalledNotice: '未检测到内置 Hermes Agent runtime，请先执行打包前构建脚本。',
    coworkHermesReadyNotice: 'Hermes Agent runtime 已就绪。开始任务时会自动启动网关。',
  ...
  en: {
    ...
    coworkAgentEngineHermes: 'Hermes Agent',
    coworkAgentEngineHermesHint: 'WeSight-managed Hermes Agent runtime for using Hermes local agent capabilities through chat.',
    coworkAgentEngineClaudeLegacy: 'Cowork',
    ...
    coworkAgentEngineCodex: 'Codex',
    coworkAgentEngineCodexHint: 'Reads the local Codex CLI and Codex configuration for OpenAI Codex-powered local tasks.',
    ...
    coworkAgentConfigSourceHint: 'Choose which model configuration Claude Code and Codex use when a task starts.',
    coworkAgentConfigSourceWesightModel: 'Follow WeSight Model Settings',
    coworkAgentConfigSourceWesightModelHint: 'Use the current model from Settings > Model and apply it to the matching CLI before each task.',
    ...
    coworkHermesInstallHint: 'Hermes Agent runtime is managed by WeSight. Switching to this engine or starting a task will auto-start the gateway.',
    coworkHermesInstalling: 'Starting Hermes Agent...',
    ...
    coworkHermesNotInstalledNotice: 'Bundled Hermes Agent runtime was not found. Build the runtime before packaging.',
    coworkHermesReadyNotice: 'Hermes Agent runtime is ready. The gateway will auto-start when you run a task.',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao WeSight Terms of Service',
    privacyDialogDesc: 'Before using NetEase Youdao WeSight, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao WeSight Terms of Service',
